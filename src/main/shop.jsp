...
<%--            </div>--%>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <h1 class="h2 pb-4">${sessionScope.productCat == null ? "Categories" : productCat.name}</h1>
                    <div class="col-md-6">
                        <c:if test="${shop != null}">
                            <ul class="list-inline shop-top-menu pb-3 pt-1">
                                ...
                                <c:forEach var="cat" items="${shop}">
                                    <li class="list-inline-item">
                                        <a class="h3 text-dark text-decoration-none mr-3" href="product-cat?category=${cat.slug}&action=${cat.hashCode()}">${cat.name}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </c:if>
